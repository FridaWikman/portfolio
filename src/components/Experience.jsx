...
const experiences = [
  {
    ...
    description: (
      <>
        Continued at{" "}
        <span className="accent-color font-semibold">Nejla AB</span> after my
        internship on a{" "}
        <span className="accent-color font-semibold">fixed-term contract</span>.
        Focused on further migrating the codebase from{" "}
        <span className="accent-color font-semibold">JavaScript</span> to{" "}
        <span className="accent-color font-semibold">TypeScript</span>, and
        helped complete the transition from{" "}
        <span className="accent-color font-semibold">Vue 2</span> to{" "}
        <span className="accent-color font-semibold">Vue 3</span> using{" "}
        <span className="accent-color font-semibold">Nuxt 3</span>. Continued
        building and refining reusable components, improving form logic and
        validation with <span className="accent-color font-semibold">Zod</span>{" "}
        and <span className="accent-color font-semibold">Vee-Validate</span>.
        Also contributed to{" "}
        <span className="accent-color font-semibold">code reviews</span> and{" "}
        <span className="accent-color font-semibold">feature planning</span>.
      </>
    ),
  },
  {
