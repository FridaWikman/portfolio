...
const projects = [
  ...
  //   title: 'Candy Shop',
  //   description:
  //     'An interactive e-commerce web app where users can browse products, add items to a cart, save favorites, and complete a simulated checkout process.',
  //   stack: ['Vue', 'Pinia'],
  //   image: CandyWorldImg,
  //   urls: { 'https://github.com/billster07/candyworld': 'hugeicons:github' },
  // },
]
      ...
      {projects.map((project, index) => (
        ...
        >
          <img
            src={project.image}
            alt={project.title}
            className="w-full lg:max-w-1/2 rounded shadow-lg"
          />
          <div
